        ...
        <form action="{{ route('agent.update', ['id' => $agent->id]) }}" method="post" autocomplete="off">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 md:gap-10">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="opening_balance" name="opening_balance" class="mt-1 p-2 w-full border-2 border-red-600 " placeholder="Enter Opening Balance" value="{{$agent->opening_balance}}">
                </div>
            </div>
