    ...
    <div x-data="{ tab: 'home' }">
        ...
        <ul class="flex border-b">
            <li class="mr-1">
                <button @click="tab = 'home'"
                    :class="tab === 'home' ? 'bg-white border-l border-t border-r rounded-t text-blue-700 font-semibold' : 
                        'text-gray-500 hover:bg-white hover:border-l hover:border-t hover:border-r hover:rounded-t hover:text-blue-700 hover:font-semibold'"
                    class="px-4 py-2">
                    Invoice
                </button>
            </li>
            <li class="mr-1">
                <button @click="tab = 'profile'"
                    :class="tab === 'profile' ? 'bg-white border-l border-t border-r rounded-t text-blue-700 font-semibold' : 
                        'text-gray-500 hover:bg-white hover:border-l hover:border-t hover:border-r hover:rounded-t hover:text-blue-700 hover:font-semibold'"
                    class="px-4 py-2">
                    Contract
                </button>
            ...
            <li class="mr-1">
                <button @click="tab = 'contact'"
                    :class="tab === 'contact' ? 'bg-white border-l border-t border-r rounded-t text-blue-700 font-semibold' : 
                        'text-gray-500 hover:bg-white hover:border-l hover:border-t hover:border-r hover:rounded-t hover:text-blue-700 hover:font-semibold'"
                    class="px-4 py-2">
                    Wakala
                </button>
        ...
        <div class="p-4 border border-t-0">
            <div x-show="tab === 'home'">
                <div id="tab1">
                    <div class="mb-2">
                        <button
                            class="py-2 px-7 border-green-700 hover:bg-green-700 hover:text-white duration-300 border-2 text-green-700  rounded-2xl font-bold"
                            onchange="toggleVisibility()" id="addnew">Add
                            New
                        </button>
                    </div>
                ...
                px-2  text-gray-900">
                    ...
                    @if (in_array('entry', $permissionsArray))
                        <form action="/addorder" method="POST" id="addorder" class="w-[80%] p-5 bg-white shadow-lg"
                            id="addorder">
                            @csrf
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="flex flex-col md:flex-row md:items-center gap-3">
                                        <label for="invoice" class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                            Invoice No.
                                        </label>
                                        <input type="text" id="order_invoice" readonly value="{{ $order_invoice }}"
                                    ...
                                    <!-- Invoice Date -->
                                    <div class="flex flex-col md:flex-row md:items-center gap-3">
                                        <label for="date" class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                            Invoice Date
                                        </label>
                                ...
                                <!-- Quantity & Invoice Type Row -->
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Quantity -->
                                    <div class="flex flex-col md:flex-row md:items-center gap-3">
                                        <label for="num" class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                            Quantity
                                        </label>
                                    ...
                                    <!-- Invoice Type -->
                                    <div class="flex flex-col md:flex-row md:items-center gap-3">
                                        <label for="type" class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                            Invoice Type
                                        </label>
                                        <select id="type"
                                            class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            ...
                            <div class="mt-4 md:mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">

                                <!-- Client Name Field -->
                                <div class="flex flex-col md:flex-row md:items-center gap-3">
                                    <label for="agent" class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                        Client Name
                                    </label>
                                    <select name="agent" id="agent" required
                                        class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm
                                         rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 select2">
                                ...
                                <!-- Supplier Field -->
                                <div class="flex flex-col md:flex-row md:items-center gap-3">
                                    <label for="supplier" class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                        Supplier
                                    </label>
                                    <select name="supplier" id="supplier" required
                                        class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                        <option value="" disabled selected>Select Supplier</option>
                                        @foreach ($suppliers as $supplier)
                                            <option value="supplier_{{ $supplier->id }}">
                                                {{ $supplier->name }} @if ($supplier->company)
                                                    ({{ $supplier->company }})
                                                @endif
                                            </option>
                                        @endforeach
                            ...
                            <div class="mt-4 md:mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <!-- Passenger Name Field -->
                                <div class="flex flex-col md:flex-row md:items-center gap-3">
                                    <label for="name" class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                        Passenger Name
                                    </label>
                                ...
                                <div class="flex flex-col md:flex-row md:items-center gap-3">
                                    <label for="passport_no" class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                        Passport No
                                    </label>
                                    <input type="text" id="passport_no" name="passport_no[]" maxlength="9"
                                        ...
                                        placeholder="AB1234567" pattern="[A-Za-z]{2}\d{7}"
                                        title="Passport format: 2 letters followed by 7 digits" required>
                                </div>
                            </div>


                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 md:mt-4">
                                <!-- Agent Price Field -->
                                <div class="flex flex-col md:flex-row md:items-center gap-3">
                                    <label for="contact_amount"
                                        class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                        Agent Price
                                    </label>
                                    
                                    <input type="number" id="contact_amount" name="contact_amount"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 mt-4 md:mt-4">
                                <!-- Country Select Field -->
                                <div class="flex flex-col md:flex-row md:items-center gap-3">
                                    <label for="country" class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                        Country
                                    </label>
                                    <select required
                                        class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 select2"
                                ...
                                <!-- Remark Textarea -->
                                <div class="flex flex-col md:flex-row md:items-center gap-3">
                                    <label for="remark" class="w-full md:w-2/5 text-gray-700 text-sm font-medium">
                                        Remark
                                    </label>
                    ...
                    <div class="p-6 rounded-lg mt-5 bg-white py-3">
                        <table class="table divide-y divide-gray-200 table-hover no-wrap datatable" id="ordertable">
                                            ...
                                            <section class="flex gap-2 text-lg">
                                                ...
                                                @if (in_array('delete', $permissionsArray))
                                                    <a href="{{ route('order.delete', ['id' => $order->id]) }}"
                                                        id="deleteOrderLink" data-toggle="modal"
        ...
        <div x-show="tab === 'profile'" x-cloak>
            <div class="mb-2">
                <button
                    class="py-2 px-7 border-green-700 hover:bg-green-700 hover:text-white duration-300 border-2 text-green-700  rounded-2xl font-bold"
                    onchange="toggleVisibilitycontract()" id="addnewcontract">Add
                    New Contract
                </button>
            </div>
            <h2 class="text-2xl py-4 flex  w-full mx-auto font-bold
                ...
                <div class="bg-white shadow-md rounded-lg p-6 mb-10" id="contractform">
                    ...
                    <form action="{{ route('contracts.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Passport No -->
                            <div>
                                <label for="passport_no" class="block text-sm font-medium text-gray-700 mb-1">Passport
                                    No</label>
            ...
            <div class="bg-white shadow-md rounded-lg p-6 mt-4">
                ...
                <div class="overflow-x-auto">
                    <table id="contracts-table" class="min-w-full divide-y divide-gray-200 text-sm text-left datatable">
                            ...
                            @foreach ($contracts as $key => $contract)
                                ...
                                <div id="modal_{{ $contract->id }}"
                                    ...
                                    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-auto relative p-6">
                                        ...
                                        <!-- Modal Header -->
                                        <h2 class="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Contract
                                            Details</h2>

                                        <!-- Static Info -->
                                        <div class="space-y-2 mb-4">
                                            <p><span class="font-medium text-gray-700">Total Amount:</span> <span
                                                    class="text-blue-600 font-semibold">{{ $contract->total_amount }}</span>
                                            </p>
                                            <p><span class="font-medium text-gray-700">Notes:</span> <span
                                                    class="text-gray-600">{{ $contract->notes }}</span></p>
                                        </div>
                    ...
                    <div id="contractModal"
                        ...
                        <div
                            class="bg-white w-full max-w-3xl max-h-[90vh] rounded-lg shadow-lg p-6 relative overflow-hidden">
                                        ...
                                        @foreach ($types as $type)
                                            <div class="flex items-start">
                                                <div class="flex items-center h-5">
                                                    <input id="type_{{ $type->id }}" name="types[]"
    ...
    <script>
        ...
        $('#num').on('change', function(event) {
            ...
            if (number_of_orders > 1) {
                ...
                $('#name').addClass('bg-gray-400');
                $('#passport_no').addClass('bg-gray-400');
            } else {
                $('#name').prop('disabled', false);
                $('#name').removeClass('bg-gray-400');
                $('#passport_no').removeClass('bg-gray-400');
                $('#passport_no').removeClass('bg-gray-400');
            }
        });
        ...
        $('#submit_invoice').on('click', function(event) {
            ...
            var invoiceNo = $("#order_invoice").val();
